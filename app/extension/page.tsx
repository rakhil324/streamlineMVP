...
const ExtensionPage = () => {
  ...
  const mockApplicationFields = [
    { id: 'name', label: 'Full Name', value: 'Demo User', filled: autofilledFields.has('name') },
    { id: 'email', label: 'Email', value: 'demo@streamline.ai', filled: autofilledFields.has('email') },
    { id: 'phone', label: 'Phone', value: '+1 555-123-4567', filled: autofilledFields.has('phone') },
    { id: 'location', label: 'Location', value: 'San Francisco, CA', filled: autofilledFields.has('location') },
    { id: 'resume', label: 'Resume', value: 'demo_resume.pdf', filled: autofilledFields.has('resume') },
      ...
      <div className="w-[420px] h-[680px] bg-white rounded-xl shadow-xl border border-gray-200 overflow-hidden flex flex-col">
        ...
        <div className="h-14 bg-white border-b border-gray-200 px-4 flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <span className="font-semibold text-textPrimary text-sm">Streamline</span>
          </div>
          <div className="flex items-center gap-2">
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center gap-3 pb-4 border-b border-gray-200">
                  ...
                  <div className="flex-1">
                    <p className="font-semibold text-textPrimary">Demo User</p>
                  </div>
                </div>
                ...
                <div className="space-y-2">
                  {[
                    ...
                    { label: 'Email', value: 'demo@streamline.ai' },
                ...
                <div>
                  ...
                  <div className="space-y-2">
                    {[
                      { school: 'Stanford University', degree: "Master's, Computer Science", years: '2020 – 2022' },
                    ].map((edu, i) => (
                      <div
                        key={i}
